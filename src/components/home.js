...
const Home = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-wrap justify-center border-solid border-1 border-gray-300">
      <div className="w-215 h-screen flex flex-wrap justify-center space-x-14-5 border-solid border-1 border-gray-300">
        <div className="w-118 h-screen border-solid border-1 border-gray-300">
          <Stories />
          <CardDeck />
        </div>
